...
int main(int argc, char* argv[])
{
	...
	Material blue(Color(0, 0, 1), Color(0.12, 0.56, 1),
		Color(0.628281, 0.555802, 0.366065),
		51.2);
	...
	sphere2->translate(Vector3D(2, 2, -4));
	...
	image1.flushPixelBuffer("viewB1.bmp"); //save rendered image to file
	...
	image2.flushPixelBuffer("viewB2.bmp");
